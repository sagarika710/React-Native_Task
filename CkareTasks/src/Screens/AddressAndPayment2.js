...
export default function AddressAndPayment2({navigation}) {
  return (
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.firstrow}>
          <View style={styles.firstrowDiv}>
            <View>
              <AntDesign name="left" size={20} color="#666" style={styles.leftIcon} onPress={() => navigation.navigate('AddressAndPayment1')} />
            </View>
            <View>
        ...
        <View style={{ alignItems: 'center' }}>
          <LinearGradient colors={['#00E0C5', '#009987']} style={styles.addAddressBtnDiv}  >
            <TouchableOpacity style={styles.addAddressBtn} onPress={() => navigation.navigate('AddressAndPayment3')}>
