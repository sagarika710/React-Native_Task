         ...
         return(
             <Billcomp2 data={dinesh2}/>
                ...
                <View style={styles.paymentstatusdiv}>
                        <View style={styles.paymenttext}><Text style={{ marginBottom: 5,color:'black',fontWeight:'600',fontSize:14}}>Payment Status</Text><Text>Cash</Text></View>
                </View>
            </View>
